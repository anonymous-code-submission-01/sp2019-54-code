(* Following http://REDACTED.net/theses/REDACTED.pdf chapter 3 *)
...
(** XXX TODO: Translate REDACTED's python script *)
Section rcarry_mul.
  Context (n : nat)
          (s : Z)
          (c : list (Z * Z))
...
Module RemoveDeadLets.
  ...
  Section RemoveDeadLets.
    ...
    (* TODO(REDACTED, from REDACTED): Should I put this into the pipeline? *)
  End RemoveDeadLets.
End RemoveDeadLets.
