...
SETUPS = {
        ...
        "REDACTED_montgomery": "color=blue,mark=triangle*", 
        "REDACTED_solinas": "color=blue,mark=triangle", 
        }

# setups to combine and functions to combine them
COMBINE = [
        ("REDACTED_montgomery", "REDACTED_solinas", min),
        ]
...
LEGEND = {
        "REDACTED_montgomery": "this paper", 
        "REDACTED_solinas": "this paper", 
        "gmpvar": "GMP mpn API",
        "gmpxx": "GMP C++ API", 
...
\\begin{xtabular}{|l|p{0.7cm}|p{0.7cm}|p{0.7cm}|p{0.7cm}|p{0.9cm}|}\n"""
    ...
    cols_64 = ["REDACTED_solinas", "REDACTED_montgomery", "gmpsec", "gmpvar", "gmpxx"]
    cols_32 = ["REDACTED_solinas", "REDACTED_montgomery", "gmpsec", "gmpvar"]
    ...
    for p in sorted(data.keys()):
        ...
        for s in cols: 
            if s in data[p]:
                ...
                if "REDACTED" in s and (our_best == None or float(data[p][s]) < our_best):
