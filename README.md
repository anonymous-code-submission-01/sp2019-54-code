[![Build Status](https://api.travis-ci.org/REDACTED/REDACTED.png?branch=master)](https://travis-ci.org/REDACTED/REDACTED)

REDACTED: Synthesizing Correct-by-Construction Code for Cryptographic Primitives
=====
...
To add a new prime, add a new line to [`primes.txt`](https://github.com/REDACTED/REDACTED/blob/master/primes.txt) with your prime.  Then run
